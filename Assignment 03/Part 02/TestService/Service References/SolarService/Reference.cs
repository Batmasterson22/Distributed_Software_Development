...
namespace TestService.SolarService {
    ...
    public interface IService1 {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/XMLScheduler", ReplyAction="http://tempuri.org/IService1/XMLSchedulerResponse")]
        string XMLScheduler(string name, string dayToSchedule, string monthToSchedule, string timeToSchedule);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/XMLScheduler", ReplyAction="http://tempuri.org/IService1/XMLSchedulerResponse")]
        System.Threading.Tasks.Task<string> XMLSchedulerAsync(string name, string dayToSchedule, string monthToSchedule, string timeToSchedule);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/ShoppingCart", ReplyAction="http://tempuri.org/IService1/ShoppingCartResponse")]
        string[] ShoppingCart(string item, string quantity);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/ShoppingCart", ReplyAction="http://tempuri.org/IService1/ShoppingCartResponse")]
        System.Threading.Tasks.Task<string[]> ShoppingCartAsync(string item, string quantity);
    }
    ...
    public partial class Service1Client : System.ServiceModel.ClientBase<TestService.SolarService.IService1>, TestService.SolarService.IService1 {
        ...
        public string XMLScheduler(string name, string dayToSchedule, string monthToSchedule, string timeToSchedule) {
            return base.Channel.XMLScheduler(name, dayToSchedule, monthToSchedule, timeToSchedule);
        }
        
        public System.Threading.Tasks.Task<string> XMLSchedulerAsync(string name, string dayToSchedule, string monthToSchedule, string timeToSchedule) {
            return base.Channel.XMLSchedulerAsync(name, dayToSchedule, monthToSchedule, timeToSchedule);
        }
        
        public string[] ShoppingCart(string item, string quantity) {
            return base.Channel.ShoppingCart(item, quantity);
        }
        
        public System.Threading.Tasks.Task<string[]> ShoppingCartAsync(string item, string quantity) {
            return base.Channel.ShoppingCartAsync(item, quantity);
        }
    }
}
